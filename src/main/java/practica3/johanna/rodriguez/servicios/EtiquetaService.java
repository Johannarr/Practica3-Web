...
import practica3.johanna.rodriguez.encapsulacion.Etiqueta;
...
public class EtiquetaService {
    ...
    public void insert(Etiqueta e){
        ...
        try	{
            ...
            Logger.getLogger(EtiquetaService.class.getName()).log(Level.SEVERE, null, e1);
        }finally{
    ...
    public List<Etiqueta> getAll() {
        ...
        try {
            ...
            Logger.getLogger(EtiquetaService.class.getName()).log(Level.SEVERE, null, e);
        }finally{
            try {
                assert con != null;
                con.close();
