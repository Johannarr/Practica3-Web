...
import practica3.johanna.rodriguez.encapsulacion.Articulo;
...
public class ArticuloService {
    ...
    public void insert(Articulo e){
        ...
        try	{
            ...
            Logger.getLogger(ArticuloService.class.getName()).log(Level.SEVERE, null, e1);
        }finally{
    ...
    public List<Articulo> getAll() {
        ...
        try {
            ...
            Logger.getLogger(ArticuloService.class.getName()).log(Level.SEVERE, null, e);
        }finally{
            try {
                assert con != null;
                con.close();
