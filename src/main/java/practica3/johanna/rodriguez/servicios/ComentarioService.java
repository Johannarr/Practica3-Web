package practica3.johanna.rodriguez.servicios;

import practica3.johanna.rodriguez.encapsulacion.Comentario;
import practica3.johanna.rodriguez.encapsulacion.Usuario;
...
//            preparedStatement.setLong(1, e.getId());
            ...
            Logger.getLogger(ComentarioService.class.getName()).log(Level.SEVERE, null, e1);
        }finally{
    ...
    public List<Comentario> getAll() {
        ...
        try {
            ...
            Logger.getLogger(ComentarioService.class.getName()).log(Level.SEVERE, null, e);
